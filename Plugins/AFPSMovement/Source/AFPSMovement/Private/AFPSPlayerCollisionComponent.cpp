...
UAFPSPlayerCollisionComponent::UAFPSPlayerCollisionComponent()
{
	PrimaryComponentTick.bCanEverTick = true;
}

// Called when the game starts
void UAFPSPlayerCollisionComponent::BeginPlay()
{
	Super::BeginPlay();
}

// Called every frame
void UAFPSPlayerCollisionComponent::TickComponent( float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction )
{
	Delta = DeltaTime;
}

void UAFPSPlayerCollisionComponent::TraceGround()
{
...
bool UAFPSPlayerCollisionComponent::SlideMove(bool Gravity)
{
	int32 NumPlanes;
	int32 NumBumps;
	FVector Planes[5];
...
void UAFPSPlayerCollisionComponent::StepSlideMove(bool Gravity)
{
...
bool UAFPSPlayerCollisionComponent::Trace(FHitResult& Result, FVector Start, FVector End)
{
...
FVector UAFPSPlayerCollisionComponent::TraceEnd(FHitResult& T)
{
...
void UAFPSPlayerCollisionComponent::VectorMA(FVector Start, float Scale, FVector End, FVector& Out)
{
