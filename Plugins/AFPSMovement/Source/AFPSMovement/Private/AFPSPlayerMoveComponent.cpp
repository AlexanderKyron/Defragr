...
UAFPSPlayerMoveComponent::UAFPSPlayerMoveComponent(const FObjectInitializer& ObjectInitializer)
...
void UAFPSPlayerMoveComponent::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void UAFPSPlayerMoveComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	Delta = DeltaTime;
...
void UAFPSPlayerMoveComponent::ApplyFriction()
{
	float speed;
	float newSpeed;
	float control;
...
void UAFPSPlayerMoveComponent::GroundMove()
{
	if(CheckJump())
	{
		AirMove();
...
void UAFPSPlayerMoveComponent::AirMove()
{
	FVector wishDirection;
...
void UAFPSPlayerMoveComponent::AirControl(FVector WishDirection, float WishSpeed)
{
...
void UAFPSPlayerMoveComponent::ApplyAcceleration(FVector WishDirection, float WishSpeed, float DynamicAcceleration)
{
	float AddSpeed;
...
void UAFPSPlayerMoveComponent::FlyMove()
{
...
bool UAFPSPlayerMoveComponent::CheckJump()
{
	if(WishJump)
	{
...
void UAFPSPlayerMoveComponent::QueueJump()
{
...
float UAFPSPlayerMoveComponent::CmdScale()
{
	int		max;
	float	total;
	float	scale;
...
void UAFPSPlayerMoveComponent::ClipVelocity(FVector In, FVector Normal, FVector& Out, float Overbounce)
{
...
void UAFPSPlayerMoveComponent::SetOrigin(FVector Position)
{
	Origin = Position;
}

FVector UAFPSPlayerMoveComponent::GetOrigin()
{
	return Origin;
}